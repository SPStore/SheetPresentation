...
public extension SPWrapper where Base: UIViewController {
    ...
    func presentSheetViewController(
        ...
        if UIDevice.current.userInterfaceIdiom == .pad {
            ...
            viewControllerToPresent.transitioningDelegate = viewControllerToPresent.sp.transitioningManager
        }
